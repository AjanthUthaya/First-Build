  ...
  function e(e) {
    function t(t) {
      var a = {
        ...
        i = {};
      for (var n in a) i[n.toLowerCase()] = a[n];
      return t = (t + "").toLowerCase(), i[t] || a.scheduler
    }
    e.config.key_nav = !0, e.config.key_nav_step = 30, e.addShortcut = function(e, a, i) {
        ...
        if (n) {
          ...
          if (r.length) return n.prototype.findHandler(r[0])
        }
      ...
      e._compose = function() {
        ...
        parse: function(e) {
          for (var t = [], a = this.getExpressions(this.trim(e)), i = 0; i < a.length; i++) {
            for (var n = this.getWords(a[i]), r = this.createCommand(), s = 0; s < n.length; s++) this.commandKeys[n[s]] ? r.modifiers[n[s]] = !0 : this.specialKeys[n[s]] ? r.keyCode = this.specialKeys[n[s]] : r.keyCode = n[s].charCodeAt(0);
            t.push(r)
          }
          return t
        },
        getCommandFromEvent: function(e) {
          ...
          t.modifiers.shift = !!e.shiftKey, t.modifiers.alt = !!e.altKey, t.modifiers.ctrl = !!e.ctrlKey, t.modifiers.meta = !!e.metaKey, t.keyCode = e.which || e.keyCode;
      ...
      function() {
        e.$keyboardNavigation.getFocusableNodes = e._getFocusableNodes, e.$keyboardNavigation.trapFocus = function(t, a) {
          ...
          for (var i = e.$keyboardNavigation.getFocusableNodes(t), n = document.activeElement, r = -1, s = 0; s < i.length; s++)
            if (i[s] == n) {
              r = s;
              break
            }
          var d, o;
          if (a.shiftKey) {
            if (d = 0 >= r ? i[i.length - 1] : r - 1, o = i[d]) return o.focus(), a.preventDefault(), !0
          } else if (d = r >= i.length - 1 ? 0 : r + 1, o = i[d]) return o.focus(), a.preventDefault(), !0;
          return !1
        }
        ...
        renderMultiple: function(t, a, i) {
          for (var n = [], r = new Date(t), s = new Date(Math.min(a.valueOf(), e.date.add(e.date.day_start(new Date(t)), 1, "day").valueOf())); r.valueOf() < a.valueOf();) n = n.concat(i.call(this, r, new Date(Math.min(s.valueOf(), a.valueOf())))),
            r = e.date.day_start(e.date.add(r, 1, "day")), s = e.date.day_start(e.date.add(r, 1, "day")), s = new Date(Math.min(s.valueOf(), a.valueOf()));
          return n
        },
        ...
        addDataAttributes: function(t, a, i, n) {
          for (var r = e.date.date_to_str(e.config.api_date), s = r(a), d = r(i), o = 0; o < t.length; o++) t[o].setAttribute("data-start-date", s),
            t[o].setAttribute("data-end-date", d), n && t[o].setAttribute("data-section", n)
        },
        addWaiAriaLabel: function(t, a, i, n) {
          var r = "",
            ...
            d = s.mode,
            o = !1;
          r += e.templates.day_date(a), e.date.day_start(new Date(a)).valueOf() != a.valueOf() && (r += " " + e.templates.hour_scale(a), o = !0), e.date.day_start(new Date(a)).valueOf() != e.date.day_start(new Date(i)).valueOf() && (r += " - " + e.templates.day_date(i), (o || e.date.day_start(new Date(i)).valueOf() != i.valueOf()) && (r += " " + e.templates.hour_scale(i))), n && (e.matrix && e.matrix[d] ? r += ", " + e.templates[d + "_scale_label"](n.key, n.label, n) : e._props && e._props[d] && (r += ", " + e.templates[d + "_scale_text"](n.key, n.label, n)));
        ...
        renderWeekAgendaMarker: function(t, a) {
          for (var i = e.$container.querySelectorAll(".dhx_wa_day_cont .dhx_wa_scale_bar"), n = e.date.week_start(new Date(e.getState().min_date)), r = -1, s = e.date.day_start(new Date(t)), d = 0; d < i.length && (r++, e.date.day_start(new Date(n)).valueOf() != s.valueOf()); d++) n = e.date.add(n, 1, "day");
        ...
        renderTimelineMarker: function(t, a, i) {
          ...
          if (d.valueOf() < e._min_date.valueOf() && (d = new Date(e._min_date)), o.valueOf() > e._max_date.valueOf() && (o = new Date(e._max_date)), !n._trace_x) return s;
          for (var l = 0; l < n._trace_x.length && !e._is_column_visible(n._trace_x[l]); l++);
          if (l == n._trace_x.length) return s;
          var _ = r[i];
          if (!(a > d && o > t)) return s;
          var c = this.createElement(),
            ...
            v = n._section_height[i] - 1 || n.dy - 1,
            g = 0;
          e._isRender("cell") && (g = _.offsetTop, h += n.dx, u += n.dx, _ = e.$container.querySelector(".dhx_cal_data"));
          var f = Math.max(1, u - h - 1);
          return c.style.cssText = "height: " + v + "px; left: " + h + "px; width: " + f + "px; top: " + g + "px;", _.insertBefore(c, _.firstChild), s.push(c), s
        },
        renderMonthCell: function(t) {
          for (var a = e.$container.querySelectorAll(".dhx_month_head"), i = [], n = 0; n < a.length; n++) i.push(a[n].parentNode);
          for (var r = e.date.week_start(new Date(e.getState().min_date)), s = -1, d = 0, o = -1, l = r, _ = e.date.day_start(new Date(t)), n = 0; n < i.length && (s++, 6 == o ? (d++, o = 0) : o++, e.date.day_start(new Date(l)).valueOf() != _.valueOf()); n++) l = e.date.add(l, 1, "day");
          if (-1 == s) return [];
          var c = e._colsS[o],
            h = e._colsS.heights[d],
            u = this.createElement();
          u.style.top = h + "px", u.style.left = c + "px", u.style.width = e._cols[o] + "px", u.style.height = (e._colsS.heights[d + 1] - h || e._colsS.height) + "px";
        ...
        renderVerticalMarker: function(t, a, i) {
          ...
          if (e._props && e._props[e._mode] && i) {
            ...
            n = o.order[i];
            var l = o.order[i];
            o.days > 1 ? n = e.locate_holder_day(t) + l : (n = l, o.size && n > o.position + o.size && (n = 0))
          }
          if (s = e.locate_holder(n), !s || s.querySelector(".dhx_scale_hour")) return document.createElement("div");
          ...
          var h = this.createElement(),
            ...
            v = 36e5;
          return h.style.top = Math.round((60 * _ * 1e3 - e.config.first_hour * v) * e.config.hour_size_px / v) % u + "px", h.style.lineHeight = h.style.height = Math.max(Math.round(60 * (c - _) * 1e3 * e.config.hour_size_px / v) % u, 1) + "px",
            h.style.width = "100%", s.appendChild(h), r.push(h), r[0]
        }
        ...
        _pickEvent: function(t, a, i, n) {
          ...
          s.sort(this._compareEvents), n && (s = s.reverse());
        ...
        nextEventHandler: function(t) {
          ...
          if (!n && !t) {
            var s = e.getState();
            n = e.$keyboardNavigation.SchedulerNode.prototype._pickEvent(s.min_date, e.date.add(s.min_date, 1, "year"), null, !1);
          }
          if (n) {
        ...
        prevEventHandler: function(t) {
          ...
          if (!n && !t) {
            var s = e.getState();
            n = e.$keyboardNavigation.SchedulerNode.prototype._pickEvent(e.date.add(s.max_date, -1, "year"), s.max_date, null, !0);
          }
          if (n) {
            var d = new e.$keyboardNavigation.Event(n.id);
      ...
      e.$keyboardNavigation.Event = function(t) {
        ...
        getNode: function() {
          var t = "[event_id='" + this.eventId + "']",
            a = e.$keyboardNavigation.dispatcher.getInlineEditor(this.eventId);
        ...
        var r = e.getState(),
          s = e.matrix && e.matrix[r.mode];
        t || (t = this.getDefaultDate()), a || (a = s ? e.date.add(t, s.x_step, s.x_unit) : e.date.add(t, e.config.key_nav_step, "minute")), this.section = i || this._getDefaultSection(), this.start_date = new Date(t), this.end_date = new Date(a), this.movingDate = n || null
      }, e.$keyboardNavigation.TimeSlot.prototype = e._compose(e.$keyboardNavigation.KeyNavNode, {
        _handlers: null,
        getDefaultDate: function() {
          var t, a = e.getState(),
            i = e.matrix && e.matrix[a.mode];
          if (i) t = e.date[i.name + "_start"](new Date(a.date)),
            t = this.findVisibleColumn(t);
          else if (t = new Date(e.getState().min_date), t = this.findVisibleColumn(t), t.setHours(e.config.first_hour), !e._table_view) {
            var n = e.$container.querySelector(".dhx_cal_data");
            n.scrollTop && t.setHours(e.config.first_hour + Math.ceil(n.scrollTop / e.config.hour_size_px))
          }
          return t
        },
        clone: function(t) {
        ...
        _getMultisectionView: function() {
          var t, a = e.getState();
          return e._props && e._props[a.mode] ? t = e._props[a.mode] : e.matrix && e.matrix[a.mode] && (t = e.matrix[a.mode]),
            t
        },
        ...
        _getNextSection: function(e, t) {
          var a = this._getMultisectionView(),
            i = a.order[e],
            n = i;
          n = void 0 !== i ? i + t : a.size && a.position ? a.position : 0, n = 0 > n ? n = (a.options || a.y_unit).length - 1 : n;
        ...
        focus: function() {
          e.$keyboardNavigation.marker.render(this.start_date, this.end_date, this.section), e.$keyboardNavigation.KeyNavNode.prototype.focus.apply(this),
            e.$keyboardNavigation._pasteDate = this.start_date, e.$keyboardNavigation._pasteSection = this.section
        },
        blur: function() {
        ...
        addMonthDate: function(t, a, i) {
          ...
          switch (a) {
            ...
            case "down":
              ...
              break;
            case "left":
              n = e.date.day_start(e.date.add(t, -1, "day")),
                n = this.findVisibleColumn(n, -1);
              break;
            case "right":
          ...
          var r = e.getState();
          return (t.valueOf() < r.min_date.valueOf() || !i && t.valueOf() >= r.max_date.valueOf()) && (n = new Date(r.min_date)), n
        },
        ...
        nextTimelineSlot: function(t, a, i) {
          var n = e.getState(),
            r = e.matrix[n.mode],
            s = this._alignTimeSlot(t.start_date, e.date[r.name + "_start"](new Date(t.start_date)), r.x_unit, r.x_step),
            d = this._alignTimeSlot(t.end_date, e.date[r.name + "_start"](new Date(t.end_date)), r.x_unit, r.x_step);
          d.valueOf() <= s.valueOf() && (d = e.date.add(s, r.x_step, r.x_unit));
          var o = this.clone(t);
          switch (o.start_date = s, o.end_date = d,
            o.section = t.section || this._getNextSection(), a) {
            case "up":
            ...
            case "down":
              ...
              break;
            case "left":
              o.start_date = this.findVisibleColumn(e.date.add(o.start_date, -r.x_step, r.x_unit), -1), o.end_date = e.date.add(o.start_date, r.x_step, r.x_unit);
              break;
            case "right":
              o.start_date = this.findVisibleColumn(e.date.add(o.start_date, r.x_step, r.x_unit), 1), o.end_date = e.date.add(o.start_date, r.x_step, r.x_unit)
          }
          return (o.start_date.valueOf() < n.min_date.valueOf() || o.start_date.valueOf() >= n.max_date.valueOf()) && (i && o.start_date.valueOf() >= n.max_date.valueOf() ? o.start_date = new Date(n.max_date) : (o.start_date = e.date[n.mode + "_start"](e.date.add(n.date, "left" == a ? -1 : 1, n.mode)),
            o.end_date = e.date.add(o.start_date, r.x_step, r.x_unit))), o
        },
        nextUnitsSlot: function(t, a, i) {
          ...
          switch (a) {
            case "left":
              ...
              d.days > 1 && d.order[r] == o - 1 && e.date.add(t.start_date, -1, "day").valueOf() >= s.min_date.valueOf() && (n = this.nextDaySlot(t, a, i));
              break;
            case "right":
              r = this._getNextSection(t.section, 1), d.days > 1 && !d.order[r] && e.date.add(t.start_date, 1, "day").valueOf() < s.max_date.valueOf() && (n = this.nextDaySlot(t, a, i));
              break;
            default:
        ...
        isAfterFirstHour: function(t, a) {
          ...
          return n >= r || !a && !i && (!n && 24 == s || n == s)
        },
        isInVisibleDayTime: function(e, t) {
          return this.isBeforeLastHour(e, t) && this.isAfterFirstHour(e, t)
        },
        nextDaySlot: function(t, a, i) {
          var n, r, s = e.config.key_nav_step,
            d = this._alignTimeSlot(t.start_date, e.date.day_start(new Date(t.start_date)), "minute", s),
            o = t.start_date;
          switch (a) {
            case "up":
              if (n = e.date.add(d, -s, "minute"), !this.isInVisibleDayTime(n, !0) && (!i || this.isInVisibleDayTime(o, !0))) {
                var l = !0;
                i && e.date.date_part(new Date(n)).valueOf() != e.date.date_part(new Date(o)).valueOf() && (l = !1), l && (n = this.findVisibleColumn(e.date.add(t.start_date, -1, "day"), -1)),
                  n.setHours(e.config.last_hour), n.setMinutes(0), n = e.date.add(n, -s, "minute")
              }
              r = e.date.add(n, s, "minute");
              break;
            case "down":
              n = e.date.add(d, s, "minute");
              var _ = i ? n : e.date.add(n, s, "minute");
              if (!this.isInVisibleDayTime(_, !1) && (!i || this.isInVisibleDayTime(o, !1)))
                if (i) {
                  var l = !0;
                  e.date.date_part(new Date(o)).valueOf() == o.valueOf() && (l = !1), l && (n = this.findVisibleColumn(e.date.add(t.start_date, 1, "day"), 1)), n.setHours(e.config.first_hour), n.setMinutes(0), n = e.date.add(n, s, "minute")
                } else n = this.findVisibleColumn(e.date.add(t.start_date, 1, "day"), 1),
                  n.setHours(e.config.first_hour), n.setMinutes(0);
              r = e.date.add(n, s, "minute");
              break;
            case "left":
        ...
        nextWeekAgendaSlot: function(t, a) {
          ...
          return (t.start_date.valueOf() < r.min_date.valueOf() || t.start_date.valueOf() >= r.max_date.valueOf()) && (i = new Date(r.min_date)), n = new Date(i), n.setHours(e.config.last_hour), {
            start_date: i,
            end_date: n
          }
        },
        ...
        nextSlot: function(t, a, i, n) {
          ...
          switch (i) {
            case this._modes.units:
              r = this.nextUnitsSlot(s, a, n);
              break;
            case this._modes.timeline:
              r = this.nextTimelineSlot(s, a, n);
              break;
            case this._modes.year:
              r = this.nextMonthSlot(s, a, n);
              break;
            case this._modes.month:
              r = this.nextMonthSlot(s, a, n);
              break;
            case this._modes.weekAgenda:
              r = this.nextWeekAgendaSlot(s, a, n);
              break;
            case this._modes.list:
              r = this.nextAgendaSlot(s, a, n);
              break;
            case this._modes.dayColumns:
              r = this.nextDaySlot(s, a, n)
          }
        ...
        extendSlot: function(t, a) {
          ...
          var r = e.getState();
          return i.start_date.valueOf() < r.min_date.valueOf() && (i.start_date = this.findVisibleColumn(r.min_date), i.start_date.setHours(e.config.first_hour)), i.end_date.valueOf() > r.max_date.valueOf() && (i.end_date = this.findVisibleColumn(r.max_date, -1)),
            e.$keyboardNavigation.TimeSlot.prototype.clone(i)
        },
        ...
        extendGenericSlot: function(t, a, i, n) {
          ...
          r = this.nextSlot({
            ...
            r.start_date.valueOf() == a.start_date.valueOf() && (r = this.nextSlot({
              start_date: r.start_date,
              section: r.section
            }, i, n, !0)), r.movingDate = s;
          var d = this.extendSlotDates(a, r, r.movingDate);
          return d.end_date.valueOf() <= d.start_date.valueOf() && (r.movingDate = "end_date" == r.movingDate ? "start_date" : "end_date"), d = this.extendSlotDates(a, r, r.movingDate), r.start_date = d.start_date, r.end_date = d.end_date, r
        },
        extendSlotDates: function(e, t, a) {
          ...
          return "start_date" == a ? (i.start_date = t.start_date,
            i.end_date = e.end_date) : (i.start_date = e.start_date, i.end_date = t.start_date), i
        },
        extendMonthSlot: function(t, a) {
          ...
          return t.start_date.setHours(e.config.first_hour), t.end_date = e.date.add(t.end_date, -1, "day"), t.end_date.setHours(e.config.last_hour), t
        },
        ...
        scrollSlot: function(t) {
          ...
          (i.start_date.valueOf() < a.min_date.valueOf() || i.start_date.valueOf() >= a.max_date.valueOf()) && e.setCurrentView(new Date(i.start_date)), this.moveTo(i)
        },
        keys: {
          left: function() {
      ...
      }), e.$keyboardNavigation.TimeSlot.prototype.bindAll(e.$keyboardNavigation.TimeSlot.prototype.keys), e.$keyboardNavigation.MinicalButton = function(e, t) {
        ...
        fallback: function() {
          ...
          i[t] || (t = 0);
          var n = !0;
          if (t > i.length / 2 && (n = !1), !i[t]) {
            var r = new e.$keyboardNavigation.TimeSlot;
            return r.isValid() ? r : new e.$keyboardNavigation.DataArea
          }
          if (n) {
            for (var s = a; i[t] && s < i[t].length; s++)
              if (i[t][s] || s != i[t].length - 1 || (t++,
                  a = 0), i[t][s]) return new e.$keyboardNavigation.MinicalCell(this.container, t, s)
          } else
            for (var s = a; i[t] && s < i[t].length; s--)
              if (i[t][s] || s || (t--, a = i[t].length - 1), i[t][s]) return new e.$keyboardNavigation.MinicalCell(this.container, t, s);
        ...
        _getGrid: function() {
          for (var t = this.container.querySelectorAll(".dhx_year_body tr"), a = [], i = 0; i < t.length; i++) {
            a[i] = [];
            for (var n = t[i], r = n.querySelectorAll("td"), s = 0; s < r.length; s++) {
              var d = r[s],
                o = !0,
                l = e._getClassName(d);
              (l.indexOf("dhx_after") > -1 || l.indexOf("dhx_before") > -1 || l.indexOf("dhx_scale_ignore") > -1) && (o = !1),
              a[i][s] = o
            }
          }
          return a
      ...
      dhtmlx._modalsStack || (dhtmlx._modalsStack = []),
      function() {
        function t() {
        ...
        var l = [];
        if (e.attachEvent("onLightbox", o), e.attachEvent("onAfterLightbox", r), e.attachEvent("onAfterQuickInfo", function() {
            i()
          ...
          dhtmlx.attachEvent("onMessagePopup", function(t) {
            ...
            c && (c = c.parentNode), e.eventRemove(t, "keydown", d),
              e.event(t, "keydown", d), dhtmlx._modalsStack.push(t)
        ...
        getInlineEditor: function(t) {
          var a = e.$container.querySelector(".dhx_cal_editor[event_id='" + t + "'] textarea");
          return a && a.offsetWidth ? a : null
        },
        keyDownHandler: function(t) {
          if (!t.defaultPrevented) {
            ...
            if ((!e.$keyboardNavigation.isModal() || a && a.container && e._locate_css({
                target: a.container
              }, "dhx_minical_popup", !1)) && (!e.getState().editor_id || !this.getInlineEditor(e.getState().editor_id)) && this.isEnabled()) {
              t = t || window.event;
        ...
        function t(e) {
          e = e || window.event, d.x = e.clientX, d.y = e.clientY
        }

        function a() {
          for (var t = !1, a = !1, i = document.elementFromPoint(d.x, d.y); i && i != e._obj;) i = i.parentNode;
        ...
        document.body ? dhtmlxEvent(document.body, "mousemove", t) : dhtmlxEvent(window, "load", function() {
          ...
          var a = e.$keyboardNavigation._pasteDate,
            ...
            s = t.end_date - t.start_date,
            d = n(t);
          if (i(d), d.start_date = new Date(a), d.end_date = new Date(d.start_date.valueOf() + s), r) {
            var o = e._get_section_property();
            e.config.multisection ? d[o] = t[o] : d[o] = r
          }
          return d
        ...
        }, e.event(document, "keydown", function(t) {
          (t.ctrlKey || t.metaKey) && 86 == t.keyCode && e._buffer_event && !e.$keyboardNavigation.dispatcher.isEnabled() && (e.$keyboardNavigation.dispatcher.isActive = a())
          ...
          var d = r();
          if ((t.ctrlKey || t.metaKey) && 67 == t.keyCode) return d && (e._buffer_event = n(e.getEvent(d)),
            s = !0, e.callEvent("onEventCopied", [e.getEvent(d)])), !0;
          if ((t.ctrlKey || t.metaKey) && 88 == t.keyCode && d) {
            s = !1;
            var o = e._buffer_event = n(e.getEvent(d));
            e.updateEvent(o.id), e.callEvent("onEventCut", [o])
          }
          if ((t.ctrlKey || t.metaKey) && 86 == t.keyCode && a(t)) {
            var o = e._buffer_event ? e.getEvent(e._buffer_event.id) : e._buffer_event;
            if (o = o || e._buffer_event) {
              var l = e._make_pasted_event(o);
              if (s) l.id = e.uid(), e._do_paste(s, l, o);
              else {
                var _ = e.callEvent("onBeforeEventChanged", [l, t, !1, o]);
                _ && (e._do_paste(s, l, o), s = !0)
              }
            }
            return !0
          }
      ...
      function() {
        ...
        e.$keyboardNavigation.attachSchedulerHandlers = function() {
          function t(t) {
            ...
            var a, i = e.$keyboardNavigation.isChildOf(t.target || t.srcElement, e.$container.querySelector(".dhx_cal_data")),
              r = e.getActionData(t);
            e._locate_event(t.target || t.srcElement) ? a = new e.$keyboardNavigation.Event(e._locate_event(t.target || t.srcElement)) : i && (a = new e.$keyboardNavigation.TimeSlot, r.date && i && (a = a.nextSlot(new e.$keyboardNavigation.TimeSlot(r.date, null, r.section)))), a && (n.isEnabled() ? r.date && i && n.delay(function() {
              n.setActiveNode(a)
            }) : n.activeNode = a)
          }

          function a(t) {
            if (e.config.key_nav && n.isEnabled()) {
              var a = t,
                i = new e.$keyboardNavigation.Event(a.eventId);
              if (!i.isValid()) {
                var r = i.start || a.start,
                  s = i.end || a.end,
                  d = i.section || a.section;
                i = new e.$keyboardNavigation.TimeSlot(r, s, d), i.isValid() || (i = new e.$keyboardNavigation.TimeSlot)
              }
              n.setActiveNode(i);
              var o = n.getActiveNode();
              o && o.getNode && document.activeElement != o.getNode() && n.focusNode(n.getActiveNode())
            }
          }
          var i, n = e.$keyboardNavigation.dispatcher,
            r = function(t) {
              return e.config.key_nav ? n.keyDownHandler(t) : void 0
            },
            s = function() {
              n.focusGlobalNode()
            };
          e.attachEvent("onDataRender", function() {
            e.config.key_nav && n.isEnabled() && !e.getState().editor_id && (clearTimeout(i), i = setTimeout(function() {
              n.isEnabled() || n.enable();
              var t = n.getActiveNode();
              t instanceof e.$keyboardNavigation.MinicalButton || t instanceof e.$keyboardNavigation.MinicalCell || (t.isValid() ? n.focusNode(t) : n.setActiveNode(t.fallback()), n.focusNode(n.getActiveNode()))
            }))
          }), e.attachEvent("onSchedulerReady", function() {
            var a = e.$container;
            e.eventRemove(document, "keydown", r), e.eventRemove(a, "mousedown", t), e.eventRemove(a, "focus", s), e.config.key_nav ? (e.event(document, "keydown", r), e.event(a, "mousedown", t), e.event(a, "focus", s), a.setAttribute("tabindex", "0")) : a.removeAttribute("tabindex");
          });
          var d = e.updateEvent;
          e.updateEvent = function(t) {
            var i = d.apply(this, arguments);
            if (e.config.key_nav && n.isEnabled() && e.getState().select_id == t) {
            ...
            if (n.isEnabled()) {
              ...
              a.eventId == t && n.setActiveNode(new e.$keyboardNavigation.TimeSlot)
            }
            return !0
          }), e.attachEvent("onClearAll", function() {
            return e.config.key_nav ? void(n.isEnabled() && n.getActiveNode() instanceof e.$keyboardNavigation.Event && n.setActiveNode(new e.$keyboardNavigation.TimeSlot)) : !0;
          })
          ...
          function a(t) {
            var a = t.target || t.srcElement,
              ...
              s = e._locate_css(t, "dhx_year_body", !1),
              d = 0,
              o = 0;
            if (s) {
              for (var l, _, c = a; c && "td" != c.tagName.toLowerCase();) c = c.parentNode;
              if (c && (_ = c, l = _.parentNode), l && _) {
                for (var h = l.parentNode.querySelectorAll("tr"), u = 0; u < h.length; u++)
                  if (h[u] == l) {
                    d = u;
                    break
                  }
                for (var v = l.querySelectorAll("td"), u = 0; u < v.length; u++)
                  if (v[u] == _) {
                    o = u;
                    break
                  }
            ...
            i.delay(function() {
              if (n || r || s) {
                var t;
                n ? (t = new e.$keyboardNavigation.MinicalButton(g, 0), i.setActiveNode(new e.$keyboardNavigation.MinicalButton(g, 0))) : r ? t = new e.$keyboardNavigation.MinicalButton(g, 1) : s && (t = new e.$keyboardNavigation.MinicalCell(g, d, o)),
                  t && (i.enable(), t.isValid() && (i.activeNode = null, i.setActiveNode(t)))
              }
            })
          }
          ...
          if (e.renderCalendar) {
            ...
            e.renderCalendar = function() {
              var r = n.apply(this, arguments),
                s = e.$keyboardNavigation._minicalendars;
              e.eventRemove(r, "click", a), e.event(r, "click", a), e.eventRemove(r, "focus", t), e.event(r, "focus", t);
              for (var d = !1, o = 0; o < s.length; o++)
                if (s[o] == r) {
                  d = !0;
                  break
                }
              if (d || s.push(r), i.isEnabled()) {
                var l = i.getActiveNode();
                l && l.container == r ? i.focusNode(l) : r.setAttribute("tabindex", "0");
          ...
          if (e.destroyCalendar) {
            ...
            e.destroyCalendar = function(a, i) {
              ...
              if (!a || !a.parentNode)
                for (var s = e.$keyboardNavigation._minicalendars, d = 0; d < s.length; d++) s[d] == a && (e.eventRemove(s[d], "focus", t), s.splice(d, 1), d--);
              return n
            }
          }
        };
