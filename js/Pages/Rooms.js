   ...
   $("#AddRoomForm").submit(function(event) {
      ...
      RoomRequest.done(function(data) {
         if (data.Status == 'Error') {
            ...
            var AccordionItem = '<li class="Accordion-Item"><a class="accordion-title">' + data.Label + '<span class="fa fa-trash Room-Delete" id="DeleteRoomButton" value="' + data.Room_Id + '"></span></a></li>';
