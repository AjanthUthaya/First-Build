...
window.dhtmlXScheduler = window.scheduler = {
  ...
  function() {
    ...
    dhtmlxEventable(scheduler), scheduler._detachDomEvent = function(e, t, i) {
        ...
        t = t || scheduler._currentDate(), i = i || "week", this._obj && this.unset_actions(), this._obj = "string" == typeof e ? document.getElementById(e) : e, this.$container = this._obj, this.config.wai_aria_attributes && this.config.wai_aria_application_role && this.$container.setAttribute("role", "application"), this._skin_init && scheduler._skin_init(),
        ...
        var r = {};
        e && null !== e.constructor.toString().match(/object/i) && (r = e,
          e = null);
        ...
        var n, d = "dhx_multi_day",
          o = this._mode == t && this.config.preserve_scroll ? this._els[i][0].scrollTop : !1;
        ...
        if (this.templates[this._mode + "_date"]) {
          ...
          else if (this._reset_hours_scale(t, n, a),
            i.multi_day) {
            var l = "dhx_multi_day";
        ...
        if (e && e.focus)
          if (this.config.touch) window.setTimeout(function() {
            e.focus()
          }, 10);
          else try {
      ...
      function() {
        ...
        _add_days: function(e, t) {
          ...
          return t >= 0 && !e.getHours() && i.getHours() && (i.getDate() < e.getDate() || i.getMonth() < e.getMonth() || i.getFullYear() < e.getFullYear()) && i.setTime(i.getTime() + 36e5 * (24 - i.getHours())),
            i
        },
        add: function(e, t, i) {
