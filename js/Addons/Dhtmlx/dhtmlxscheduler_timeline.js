  ...
  e._temp_matrix_scope = function() {
    e.matrix = {}, e._merge = function(e, t) {
      ...
      var h = t.color ? "background:" + t.color + ";" : "",
        ...
        f = "<div " + e._waiAria.eventBarAttrString(t) + " event_id='" + t.id + "' class='" + c + "' style='" + h + u + "position:absolute; top:" + _ + "px; height: " + o + "px; left:" + (r - 0) + "px; width:" + Math.max(0, s - r) + "px;" + (t._text_style || "") + "'>";
