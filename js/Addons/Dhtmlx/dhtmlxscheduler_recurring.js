...
Scheduler.plugin(function(e) {
  e.config.occurrence_timestamp_in_utc = !1, e.config.recurring_workdays = [1, 2, 3, 4, 5], e.form_blocks.recurring = {
      ...
      _init_set_value: function(t, a, n) {
        ...
        function r() {
          y("dhx_repeat_day").style.display = "none",
            y("dhx_repeat_week").style.display = "none", y("dhx_repeat_month").style.display = "none", y("dhx_repeat_year").style.display = "none", y("dhx_repeat_" + this.value).style.display = "block", e.setLightboxSize()
        }

        function s(t) {
          var a = [c(p, "repeat")];
          for (b[a[0]](a, t); a.length < 5;) a.push("");
          var n = "",
            i = d(p);
          if ("no" == i) t.end = new Date(9999, 1, 1), n = "no";
          else if ("date_of_end" == i) t.end = v(c(p, "date_of_end"));
          else {
            e.transpose_type(a.join("_")), n = Math.max(1, c(p, "occurences_count"));
            var r = 0;
        ...
        function l(t, a) {
          ...
          switch (t = i[0].split("_"), x[t[0]](t, a), i[1]) {
            ...
            case "":
              o(p, "date_of_end");
              var r = a.end;
              e.config.include_end_by && (r = e.date.add(r, -1, "day")), n(p, "date_of_end", f(r));
              break;
            default:
              o(p, "occurences_count"), n(p, "occurences_count", i[1])
          }
          n(p, "repeat", t[0]);
          var s = e.form_blocks.recurring._get_form_node(p, "repeat", t[0]);
          "SELECT" == s.nodeName && s.onchange ? s.onchange() : s.onclick && s.onclick()
        }
        ...
        var u = e.date.str_to_date(e.config.repeat_date),
          ...
          g = t.getElementsByTagName("FORM")[0],
          p = {};
        if (i(g.getElementsByTagName("INPUT")), i(g.getElementsByTagName("SELECT")), !e.config.repeat_date_of_end) {
        ...
        e.form_blocks.recurring._get_repeat_code = s;
        var b = {
            month: function(t, a) {
              var n = e.form_blocks.recurring._get_node_value,
                i = e.form_blocks.recurring._get_node_numeric_value;
              "d" == n(p, "month_type") ? (t.push(Math.max(1, i(p, "month_count"))), a.start.setDate(n(p, "month_day"))) : (t.push(Math.max(1, i(p, "month_count2"))), t.push(n(p, "month_day2")), t.push(Math.max(1, i(p, "month_week2"))), e.config.repeat_precise || a.start.setDate(1)),
                a._start = !0
            },
            week: function(t, a) {
              var n = e.form_blocks.recurring._get_node_value,
                i = e.form_blocks.recurring._get_node_numeric_value;
              t.push(Math.max(1, i(p, "week_count"))), t.push(""), t.push("");
              for (var r = [], s = n(p, "week_day", !0), d = a.start.getDay(), o = !1, l = 0; l < s.length; l++) r.push(s[l]), o = o || s[l] == d;
              r.length || (r.push(d), o = !0), r.sort(), e.config.repeat_precise ? o || (e.transpose_day_week(a.start, r, 1, 7), a._start = !0) : (a.start = e.date.week_start(a.start), a._start = !0), t.push(r.join(","))
            },
            day: function(t) {
              var a = e.form_blocks.recurring._get_node_value,
                n = e.form_blocks.recurring._get_node_numeric_value;
              "d" == a(p, "day_type") ? t.push(Math.max(1, n(p, "day_count"))) : (t.push("week"), t.push(1), t.push(""), t.push(""), t.push(e.config.recurring_workdays.join(",")), t.splice(0, 1))
            },
            year: function(t, a) {
              var n = e.form_blocks.recurring._get_node_value;
              "d" == n(p, "year_type") ? (t.push("1"), a.start.setMonth(0), a.start.setDate(n(p, "year_day")), a.start.setMonth(n(p, "year_month"))) : (t.push("1"), t.push(n(p, "year_day2")), t.push(n(p, "year_week2")), a.start.setDate(1), a.start.setMonth(n(p, "year_month2"))), a._start = !0
            }
          },
          x = {
            week: function(t, a) {
              var n = e.form_blocks.recurring._set_node_value;
              n(p, "week_count", t[1]);
              for (var i = t[4].split(","), r = {}, s = 0; s < i.length; s++) r[i[s]] = !0;
              n(p, "week_day", r)
            },
            month: function(t, a) {
              var n = e.form_blocks.recurring._set_node_value;
              "" === t[2] ? (n(p, "month_type", "d"), n(p, "month_count", t[1]), n(p, "month_day", a.start.getDate())) : (n(p, "month_type", "w"), n(p, "month_count2", t[1]), n(p, "month_week2", t[3]), n(p, "month_day2", t[2]))
            },
            day: function(t, a) {
              var n = e.form_blocks.recurring._set_node_value;
              n(p, "day_type", "d"), n(p, "day_count", t[1]);
            },
            year: function(t, a) {
              var n = e.form_blocks.recurring._set_node_value;
              "" === t[2] ? (n(p, "year_type", "d"), n(p, "year_day", a.start.getDate()), n(p, "year_month", a.start.getMonth())) : (n(p, "year_type", "w"), n(p, "year_week2", t[3]), n(p, "year_day2", t[2]), n(p, "year_month2", a.start.getMonth()))
            }
          };
        e.form_blocks.recurring._set_repeat_code = l;
    ...
    function() {
      var t = e.addEvent;
      e.addEvent = function(a, n, i, r, s) {
        var d = t.apply(this, arguments);
        if (d) {
          var o = e.getEvent(d);
          this._is_modified_occurence(o) && e._add_rec_marker(o, 1e3 * o.event_length), o.rec_type && (o.rec_pattern = o.rec_type.split("#")[0])
        }
        return d
      }
      ...
      if (this._is_virtual_event(e) || this._is_modified_occurence(t) && t.rec_type && "none" != t.rec_type) {
        ...
        var s = this._get_rec_markers(e);
        for (var d in s) s.hasOwnProperty(d) && (e = s[d].id, this.getEvent(e) && this.deleteEvent(e, !0))
      }
      return !0
      ...
      if (this._is_virtual_event(e)) {
        ...
        for (var s in r) r.hasOwnProperty(s) && (delete this._rec_markers[r[s].id],
          this.deleteEvent(r[s].id, !0));
        delete this._rec_markers_pull[e];
        for (var d = !1, o = 0; o < this._rendered.length; o++) this._rendered[o].getAttribute("event_id") == e && (d = !0);
    ...
    e.attachEvent("onEventCreated", function(e) {
      ...
      if (!r || "0" === r || !a.labels.confirm_recurring || "instance" == n || "series" == n && !s) return this.showLightbox_rec(t);
      if ("ask" == n) {
        var o = this;
        dhtmlx.modalbox({
    ...
    function() {
      ...
      for (var s = (t.getDay() || (e.config.start_on_monday ? 7 : 0)) - n, d = 0; d < a.length; d++)
        if (a[d] > s) return t.setDate(t.getDate() + 1 * a[d] - s - (i ? n : r));
      ...
      if (!this.date[a]) {
        var n = t.split("_"),
          i = 864e5,
          r = "add_" + t,
          s = this.transponse_size[n[0]] * n[1];
        if ("day" == n[0] || "week" == n[0]) {
          var d = null;
          if (n[4] && (d = n[4].split(","), e.config.start_on_monday)) {
            for (var o = 0; o < d.length; o++) d[o] = 1 * d[o] || 7;
            d.sort()
          }
          this.date[a] = function(t, a) {
            var n = Math.floor((a.valueOf() - t.valueOf()) / (i * s));
            n > 0 && t.setDate(t.getDate() + n * s), d && e.transpose_day_week(t, d, 1, s)
          }, this.date[r] = function(t, a) {
            var n = new Date(t.valueOf());
            if (d)
              for (var i = 0; a > i; i++) e.transpose_day_week(n, d, 0, s);
            else n.setDate(n.getDate() + a * s);
            return n
          }
        } else("month" == n[0] || "year" == n[0]) && (this.date[a] = function(t, a) {
          var i = Math.ceil((12 * a.getFullYear() + 1 * a.getMonth() - (12 * t.getFullYear() + 1 * t.getMonth())) / s);
          i >= 0 && t.setMonth(t.getMonth() + i * s), n[3] && e.date.day_week(t, n[2], n[3])
        }, this.date[r] = function(t, a) {
          var i = new Date(t.valueOf());
          return i.setMonth(i.getMonth() + a * s), n[3] && e.date.day_week(i, n[2], n[3]), i
        })
      }
    }, e.repeat_date = function(t, a, n, i, r, s) {
      i = i || this._min_date,
        r = r || this._max_date;
      var d = s || -1,
        o = new Date(t.start_date.valueOf()),
        l = 0;
      for (!t.rec_pattern && t.rec_type && (t.rec_pattern = t.rec_type.split("#")[0]), this.transpose_type(t.rec_pattern), e.date["transpose_" + t.rec_pattern](o, i); o < t.start_date || e._fix_daylight_saving_date(o, i, t, o, new Date(o.valueOf() + 1e3 * t.event_length)).valueOf() <= i.valueOf() || o.valueOf() + 1e3 * t.event_length <= i.valueOf();) o = this.date.add(o, 1, t.rec_pattern);
      for (; r > o && o < t.end_date && (0 > d || d > l);) {
        var _ = e.config.occurrence_timestamp_in_utc ? Date.UTC(o.getFullYear(), o.getMonth(), o.getDate(), o.getHours(), o.getMinutes(), o.getSeconds()) : o.valueOf(),
          c = this._get_rec_marker(_, t.id);
        if (c) n && ("none" != c.rec_type && l++, a.push(c));
        else {
          var h = new Date(o.valueOf() + 1e3 * t.event_length),
            u = this._copy_event(t);
          if (u.text = t.text, u.start_date = o, u.event_pid = t.id, u.id = t.id + "#" + Math.ceil(_ / 1e3), u.end_date = h, u.end_date = e._fix_daylight_saving_date(u.start_date, u.end_date, t, o, u.end_date), u._timed = this.isOneDayEvent(u), !u._timed && !this._table_view && !this.config.multi_day) return;
          a.push(u), n || (this._events[u.id] = u, this._rec_temp.push(u)), l++
        }
        o = this.date.add(o, 1, t.rec_pattern)
      }
      ...
      for (var r = [], s = 0; s < i.length; s++) "none" != i[s].rec_type && r.push({
        start_date: i[s].start_date,
        end_date: i[s].end_date
      });
      return r
      ...
      for (var n in this._events) {
        ...
        if (i && i.start_date < t && i.end_date > e)
          if (i.rec_pattern) {
            ...
            for (var s = 0; s < r.length; s++) !r[s].rec_pattern && r[s].start_date < t && r[s].end_date > e && !this._rec_markers[r[s].id] && a.push(r[s])
