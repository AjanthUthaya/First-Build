...
<head>
  ...
  <!-- Tab title -->
  <title>Test dates - First Build</title>
  <!-- Tab icon -->
  ...
  <link rel="stylesheet" href="css/appPartials/SearchBar.css">
  <!-- END: Partials -->
...
<body onload="init();">
  ...
  <div id="Desktop-View">
      ...
      <div class="OffCanvas-Menu-Content">
        ...
        <div class="OffCanvas-Menu-List">
          ...
          <ul class="vertical menu align-center">
            ...
            <li><a href="Major.html" data-toggle="Sub-Major">Major</a></li>
            <li><a href="Test.html" class="OffCanvas-Menu-List-Active">Test</a></li>
          </ul>
    ...
    <!-- START: Viewport -->
    <div id="Paginate" class="off-canvas-content OffCanvas-Main" data-off-canvas-content>

      <!-- START: All content goes in here -->
      <section id="Content-Main">

        <div id="OptionMain" class="Inside">
          <a id="Edit"><i class="fa fa-pencil Date-Edit"></i></a>
          <a href="NewTest.html" id="Add"><i class="fa fa-plus Date-Add"></i></a>
        </div>

        <div id="DataList">

          <div class="grid-x align-center">
            <input type="search" name="search" placeholder="Search.." class="animated-search-form search medium-12">
          </div>



          <div class="grid-x medium-up-3 large-up-4 Test-Main list">


            <!--            <data class="cell Date-Main">
              <div class="Date-Underlayer">

                <div class="Date-Date">
                  <label class="Date-Date-Month"><i>November</i></label>
                  <label class="Date-Date-DayNumber">24</label>
                  <label class="Date-Date-DayLetters">Friday</label>
                </div>
