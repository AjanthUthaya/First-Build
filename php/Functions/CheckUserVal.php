<?php
    ...
    {
        //include 'php/Functions/ClearSession.php';

        include($_SERVER['DOCUMENT_ROOT'] . '/php/Functions/ClearSession.php');


        if (isset($_SESSION['DB_User_Id'], $_SESSION['DB_User_Type'],
        $_SESSION['DB_Username'], $_SESSION['DB_Firstname'],
        $_SESSION['DB_Middlename'], $_SESSION['DB_Lastname'],
        $_SESSION['DB_Email'], $_SESSION['DB_Phone'],
        $_SESSION['DB_Birth_Date'], $_SESSION['DB_Vgs'],
        $_SESSION['DB_Img_Src'])) {
